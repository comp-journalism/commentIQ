...
(To install the API code and run it locally on your own server follow the instructions here <a href="https://github.com/comp-journalism/commentIQ/tree/master/CommentAPIcode" target="_blank">here</a> )
